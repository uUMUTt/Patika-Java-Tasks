...
public class FixtureGenerator<T extends Object> {
    ...
    public List<List<Fixture<T>>> getFixtures(List<T> teams, boolean includeReverseFixtures) {
        ...
        // If odd number of teams add a "bay".
        //The team with "bay" written as the opponent will not play that week.
        if (numberOfTeams % 2 != 0) {
            numberOfTeams++;
            teams.add((T) "Bay");//This part should be changed according to the entered T object.
        }
        ...
        //The next two loops to mix the matches
